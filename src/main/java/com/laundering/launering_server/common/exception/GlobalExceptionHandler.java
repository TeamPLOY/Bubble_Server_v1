...
import com.laundering.launering_server.common.dto.ErrorResponse;  // 에러 응답을 정의하는 DTO 클래스
...
import static com.laundering.launering_server.common.exception.ErrorCode.*;  // 에러 코드 상수를 가져오기 위한 static import
